...
export default function DecentralizationScreen({route}) {
  ...
  return (
    <SafeAreaView>
      <View style={{marginVertical: 5,flexDirection:'row',alignSelf:'center'}}>
        <Text
          style={{
            alignSelf: 'center',
            fontWeight: '700',
      ...
      <TouchableOpacity
      style={{backgroundColor:'#009387',height:30,width:100,alignSelf:'center',justifyContent:'center',borderRadius:8}}
        onPress={() => {
          firestore()
            .collection('Profiles')
            .doc(userUid)
          ...
          <Text style={{alignSelf:'center',color:'white',fontSize:15}}> Xác nhận</Text>
        </TouchableOpacity>
      {visible && (
        <View>
          <FancyAlert
